...
public class UsersDatabase {
    ...
    static final ArrayList<String> tabelePrograma = new ArrayList(Arrays.asList(new String[]
      {"auth_user", "u_entities", "u_groups", "u_group_users", "u_owners", "u_permissions", "u_permissions_group", "u_permissions_users", "django_session"}));
  ...
  public static String addNewUser(String username, String password) {
    try {
      ...
      String insert = String.format("INSERT INTO auth_user (username,password,date_joined) VALUES ('%s','%s', '%s')", username, Password.encript(password), now.toString());
