...
public class ELocalConfig extends Entity { 
  ...
  public ELocalConfig() {
   super(ID_Query, 
	 new String [] {ID_ALGatorUser, ID_TaskServerName, ID_TaskServerPort, ID_FAMILYID, ID_COMPID, ID_UID, ID_VMEP, ID_VMEPClasspath, ID_RSyncServerPort, ID_DoSyncProjects},
  ...
  public String getTaskServerName() {
    ...
    if (taskServerName == null || taskServerName.isEmpty())
      taskServerName = ADEGlobal.DEFAULT_TASK_SERVER_NAME;
    return taskServerName;
  }
  public void setTaskServerName(String name) {
    set(ID_TaskServerName, name);
  }
  
  public int getTaskServerPort() {
    return getFieldAsInt(ID_TaskServerPort, ADEGlobal.DEFAULT_TASK_SERVER_PORT);
  }
  public void setTaskServerPort(int port) {
    set(ID_TaskServerPort, port);
  }

  public int getRSyncServerPort() {
    return getFieldAsInt(ID_RSyncServerPort, ADEGlobal.DEFAULT_RSYNC_SERVER_PORT);
  }
